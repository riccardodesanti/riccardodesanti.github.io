...
My research focuses on developing **generative algorithms for discovery beyond the data** — bridging deep generative modeling (e.g., flows and diffusion models), decision-making under uncertainty, and optimization, to enable **new-to-nature discovery**. I work on mathematical foundations and scalable methods, aiming to contribute to the foundations of a **science of generative discovery**: principled methods allowing generative models to explore complex design spaces and uncover previously inaccessible regions.
